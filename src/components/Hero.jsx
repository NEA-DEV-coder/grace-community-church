export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute -left-32 top-1/4 h-72 w-72 rounded-full bg-gold-500/20 blur-3xl" />
      <div className="absolute -right-32 bottom-1/4 h-72 w-72 rounded-full bg-gold-400/10 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-32 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="font-serif text-4xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl">
          Grace Community
        ...
        {/* Service times strip */}
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-4 rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur-md sm:grid-cols-3">
          {[
