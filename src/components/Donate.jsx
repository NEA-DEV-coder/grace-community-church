            ...
            <div className="mt-8 flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/65">
                  Your donation is tax-deductible. Need help? Contact our giving
                  team.
                </p>
              </div>
            </div>
            ...
            {submitted ? (
              <div className="flex flex-col items-center py-16 text-center">
                ...
                <p className="mt-2 max-w-sm text-navy-600">
                  Your donation of ${selectedAmount} was received. A receipt has
                  been sent to your email. God bless you!
                </p>
                <button
                  type="button"
