    ...
    <section id="blog" className="bg-navy-50 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {/* Featured post */}
          <article className="group overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-xl lg:col-span-2 lg:row-span-2">
          ...
          {rest.map((post) => (
            <article
              key={post.id}
              className="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
            >
