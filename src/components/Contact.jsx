      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-3">
          {contactInfo.map((item) => (
            <div
              key={item.title}
              className="rounded-2xl border border-navy-100 bg-white p-6 text-center shadow-sm transition hover:-translate-y-1 hover:shadow-md"
            >
              ...
              {item.lines.map((line, i) => (
                <p key={i} className="mt-1 text-sm text-navy-600">
                  {line}
                </p>
              ))}
            </div>
            ...
            {submitted ? (
              <div className="flex flex-col items-center py-16 text-center">
                ...
                <p className="mt-2 max-w-sm text-navy-600">
                  Thank you, {form.name || "friend"}. Our team has received your
                  {requestType === "Prayer Request"
                    ? " prayer request"
                    : " message"}{" "}
